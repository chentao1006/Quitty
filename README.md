...
Quitty includes lightweight, anonymous usage tracking (powered by Aptabase) to help improve the app. This feature collects basic events like app launches and successful auto-quits.
- **No personally identifiable information (PII)** is collected.
- You can **opt-out at any time** by unchecking "Share anonymous usage data..." in `Settings > General`.
